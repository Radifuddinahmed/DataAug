...
output = 'Width'
input_file = f'D:\PhD_ResearchWork\ASME_Journal\datasets\Final\LPBF_Dataset_Synthetic_3831_Normalized_{output}.csv'
...
opt.to_csv(f'LPBF_ML_Model_Evaluation_Synthetic3831_{output}.csv',mode='w', index=False)
