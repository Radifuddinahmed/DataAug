...
time1 = datetime.now().strftime("%M%S")
...
def main():
    ...
    for j in range(0,100):
        ...
        for i in range(profinfo.wProfileDataCount):
            ...
            list.append([x_val_mm, y_val_mm, z_val_mm])
            # print(list)
...
o3d.io.write_point_cloud(f"SensorPcdDataGenerator{timestamp}.pcd", pcd)
o3d.io.write_point_cloud(f"SensorPcdDataGenerator{timestamp}.xyz", pcd)
o3d.visualization.draw_geometries([pcd])


time2 = datetime.now().strftime("%M%S")
print(time2)
